...
In this thesis, we seek to mitigate data privacy concerns while maintaining applicability in am ML-training context by synthesizing new EHRs which capture the medical trends and distributions as in real data without directly exposing any patient's data to the downstream models.
