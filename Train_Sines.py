...
generated_sine_data, e, r, s, d, g = timegan(sine_data, parameters, checkpoint_file=f'e{parameters["iterations"]}_no{no}.pth')
...
#Plotting a sample of generated and real data and visualization metrics
...
plot_4pane(sine_data, generated_sine_data, filename=f'3genstep_e{parameters["iterations"]}_no{no}.pdf', num_samples=15)
